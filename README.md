...
# 📖 [VITE-PROJECT-TODO-LIST] <a name="about-project"></a>
...
- cd my-project
  - git clone https://github.com/David-Lanzz/vite-project.git
### Install
...
Clone the project and run "npm run dev" in the terminal
...
- **How did you get the linters to work for the Project**
